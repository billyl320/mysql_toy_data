...
CREATE TABLE ProfessorReviews (
  ...
  communication_rating DECIMAL(2,1),   -- Rating of professor's communication (0-10.0)
  technical_rating DECIMAL(2,1),     -- Rating of professor's technical knowledge (0-10.0)
  respectfulness_rating DECIMAL(2,1)   -- Rating of professor's respectful conduct (0-10.0)
);
...
VALUES 
  ...
  (567890, 202, 'CHEM100', 'Chemistry', 9.5, 10.0, 9.8),     
  ...
  (345678, 402, 'ENGL310', 'English Literature', 10.0, 9.5, 9.8),
  (901234, 501, 'BIO202', 'Biology', 6.8, 9.9, 10.0),
  ...
  (987654, 902, 'CS404', 'Computer Science', 8.9, 10.0, 9.2), 
  (234568, 1002, 'ARTH101', 'Art History', 7.2, 6.8, 7.5), 
  (789013, 1102, 'BUSI301', 'Business', 10.0, 8.5, 7.9), 
